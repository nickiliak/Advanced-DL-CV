...
if __name__ == '__main__':
    ...
    model.to(device)
    model.eval()
    model.load_state_dict(torch.load('Exercise2.2/models/classifier/model.pth', map_location=device))
    ...
    plt.savefig('outputs/per_t_accuracy.png', bbox_inches='tight')
    ...
    show_n_forward(vis_images, fig_titles=vis_labels, save_path='Exercise2.2/outputs/clf_forward.png')
